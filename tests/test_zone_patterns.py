...
ZONES = json.loads((HERE / "assets" / "zone_names.json").read_text(encoding="utf-8"))
TRIGGERS = json.loads((HERE / "assets" / "triggers.json").read_text(encoding="utf-8"))
...
meter.set_zone_metadata("Next instance")
