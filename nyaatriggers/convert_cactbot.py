...
Usage.
    python3 -m nyaatriggers.convert_cactbot /path/to/cactbot              # prints JSON to stdout
    python3 -m nyaatriggers.convert_cactbot /path/to/cactbot out.json     # writes to a file
"""
