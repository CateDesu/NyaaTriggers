...
Usage
    python3 -m nyaatriggers.convert_event_trigger /path/to/event-trigger           # stdout
    python3 -m nyaatriggers.convert_event_trigger /path/to/event-trigger out.json  # write file
"""
