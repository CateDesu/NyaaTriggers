...
Usage
    python3 -m nyaatriggers.convert_triggernometry                  # merge into assets/triggers.json in place
    python3 -m nyaatriggers.convert_triggernometry out.json         # write to separate file
"""
